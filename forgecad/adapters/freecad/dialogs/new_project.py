...
class NewProjectDialog(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("New ForgeCAD Project")
        self.setMinimumWidth(420)

        self.name_edit = QtGui.QLineEdit()
        self.name_edit.setText("New Chassis")

        self.application_combo = QtGui.QComboBox()
        ...
        self.profile_combo.setCurrentText(library.active_name)

        form = QtGui.QFormLayout()
        form.addRow("Project name:", self.name_edit)
        form.addRow("Application:", self.application_combo)
        form.addRow("Display units:", self.units_combo)
        form.addRow("Default tube:", self.profile_combo)
